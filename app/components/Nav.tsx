          ...
          {[
            ...
            <Link
              ...
              style={{
                ...
                color: path === item.href || (item.href === "/process" && path.startsWith("/process")) || (item.href === "/strategy" && path.startsWith("/strategy")) || (item.href === "/university" && path.startsWith("/university"))
                  ? "var(--accent)"
                  : "var(--text-secondary)",
                textDecoration: "none",
